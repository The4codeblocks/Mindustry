...
public class CrashHandler{
    ...
    public static String createReport(Throwable exception){
        ...
        + (world.state != null && world.state.patcher != null && world.state.patcher.patches != null && world.state.patcher.patches.size > 0 ? "Patches: \n" + world.state.patcher.patches.toString("\n---\n", p -> p.patch) + "\n" : "")
        + "\n\n" + error;
    }
