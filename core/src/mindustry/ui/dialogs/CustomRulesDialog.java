...
public class CustomRulesDialog extends BaseDialog{
    ...
    void setupMain(){
        ...
        check("@rules.limitarea", b -> rules.limitMapArea = b, () -> rules.limitMapArea, () -> !world.state.isGame());
        numberi("x", x -> rules.limitX = x, () -> rules.limitX, () -> rules.limitMapArea && !world.state.isGame(), 0, 10000);
        numberi("y", y -> rules.limitY = y, () -> rules.limitY, () -> rules.limitMapArea && !world.state.isGame(), 0, 10000);
        numberi("w", w -> rules.limitWidth = w, () -> rules.limitWidth, () -> rules.limitMapArea && !world.state.isGame(), 0, 10000);
        numberi("h", h -> rules.limitHeight = h, () -> rules.limitHeight, () -> rules.limitMapArea && !world.state.isGame(), 0, 10000);
